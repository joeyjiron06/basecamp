  ...
  return (
    ...
    >
      ...
      <svg
        ...
        className={clsx(
          "feather feather-copy transition-all opacity-0 duration-300 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2",
      ...
      <svg
        ...
        strokeLinejoin="round"
        className={clsx(
          "feather feather-check opacity-0 transition-all duration-300",
